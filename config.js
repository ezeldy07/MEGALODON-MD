...
module.exports = {
    ...
    SESSION_ID: process.env.SESSION_ID || "MEGALODON~MD~1JYURRTb#40zFQvhMvu5CoOwGEpDM787WIQveb8cJ1gx_vCUnQD4",  // Your bot's session ID (keep it secure)
    ...
    OWNER_NUMBER: process.env.OWNER_NUMBER || "2250143444765",  // Owner's WhatsApp number
    
    OWNER_NAME: process.env.OWNER_NAME || getConfig("OWNER_NAME") || "ADD YOUR NAME",           // Owner's name
    
    DEV: process.env.DEV || "2250143444765",                     // Developer's contact number
    ...
    MENU_IMAGE_URL: getConfig("MENU_IMAGE_URL") || "https://files.catbox.moe/3q6v1e.jpeg",  // Bot's "alive" image
